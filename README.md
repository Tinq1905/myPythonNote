...
## 28th JAN ##
Awful day!
I followed the steps in the book and finished building a sample web page with *flask* , which is a tiny web frame.
Actually, I haven't understand, why is it called *tiny*.
...
*render_template* is a really important function which is frequently used in route.
*extends* (in jinjia2) can be used to easy my life in composing html files. This function helps to avoid typing repeatly contents.
